...
describe('EntryRaceDetail', (): void => {
  test.each`
    ...
    ${'馬番発表前'} | ${'2021062010511'} | ${'testdata/EntryRaceDetail_getRaceDetail_1'} | ${{ id: '2021062010511', courseid: '105', coursename: '東京', racenumber: 11, racename: 'ユニコーンＳ' }} | ${0}           | ${{ bracketnumber: undefined, horsenumber: undefined, horsename: 'イグナイター', horseid: '0001261958' }}
    ${'馬番発表後'} | ${'2021062710911'} | ${'testdata/EntryRaceDetail_getRaceDetail_2'} | ${{ id: '2021062710911', courseid: '109', coursename: '阪神', racenumber: 11, racename: '宝塚記念' }}     | ${0}           | ${{ bracketnumber: 1, horsenumber: 1, horsename: 'ユニコーンライオン', horseid: '0001295861' }}
  `(
